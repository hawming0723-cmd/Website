      ...
      <header className="hero">
        ...
        <div className="hero-grid">
          <section className="hero-copy">
            ...
            <h1>
              Hi, I’m <span>Your Name</span>, a fresh graduate building sharp digital experiences.
            </h1>
            <p className="lede">
              I’m 22 and passionate about web development, web design, and UI/UX design.
              I like creating polished websites and applications that look premium, feel intuitive,
          ...
          <aside className="hero-card">
            ...
            <p className="card-label">Core profile</p>
            <h2>Designer-first, developer-ready.</h2>
            <p>
              I enjoy turning ideas into sleek interfaces, then wiring them up with clean front-end
              and full-stack logic.
            </p>
      ...
      <main>
          ...
          <div className="project-grid">
            {projects.map((project) => (
              <article className="project-card" key={project.name}>
                <p className="project-index">0{projects.indexOf(project) + 1}</p>
                <h3>{project.name}</h3>
                <p>{project.detail}</p>
              </article>
            ))}
        ...
        <section className="section contact-section" id="contact">
          <div>
            ...
            <p>
              If you want a web portfolio, a product landing page, or a simple digital presence,
